...
This table contains information about the ID of some persons and their first and
last names.
```
...
There is no address in the `Address` table for the `personId = 1` so we return `null`
in their city and state. `addressId = 1` contains information about the address of
`personId = 2`.
